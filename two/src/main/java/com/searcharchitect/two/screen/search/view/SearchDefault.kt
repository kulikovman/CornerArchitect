...
fun SearchDefaultPreview() {
    SearchArchitectTheme {
        SearchDefault(
            ...
            locationField = remember { mutableStateOf("") },
            specializationField = remember { mutableStateOf("") },
            nameField = remember { mutableStateOf("") },
...
fun SearchDefault(
    ...
    locationField: MutableState<String>,
    specializationField: MutableState<String>,
    nameField: MutableState<String>,
    ...
    Column(modifier = Modifier.fillMaxSize()) {
        ...
        Column(
            ...
            var location by locationField
            var specialization by specializationField
            var name by nameField
